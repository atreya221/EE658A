%% Example 1 - Truck Backer-Upper Problem (using Numerical Fuzzy approach)
...
% Now, we load data of desired trajectories from 14 different initial states.
...
for i=1:length(dataDir)             % iterate over all tables
    ...
    concatTable = [concatTable; tables{i}];     % concatenate i-th table
end
...
saveas(gcf,'trucktrajectory1.png');
%% 
% 
% 
% 
